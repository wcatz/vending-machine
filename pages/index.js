...
export default function Home() {
  return (
    <div classNameName="w-full container mx-auto">
      <Head>
        <title>Vending Machine</title>
        <meta name="description" content="Nextjs Axios Tailwinds Vending Machine" />
      ...
      <div className="h-full">
        ...
        <div className="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          ...
          <div className="w-full xl:w-3/5 p-12 overflow-hidden">
            <image className="mx-auto w-full md:w-4/5 transform -rotate-6 transition hover:scale-105 duration-700 ease-in-out hover:rotate-6" src="macbook.svg" />
          </div>
          ...
          <div className="mx-auto md:pt-16">
            ...
            <div className="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
              <image src="App Store.svg" className="h-12 pr-12 transform hover:scale-125 duration-300 ease-in-out" />
              <image src="Play Store.svg" className="h-12 transform hover:scale-125 duration-300 ease-in-out" />
            </div>
          </div>
        </div>
      </div>
